...
function videoUrl(service, videoID, url, options) {
  switch (service) {
    case 'youtube': {
      ...
      finalUrl +=
        '.com/embed/' +
        (parameterPos > -1 ? videoID.substr(0, parameterPos) : videoID)
...
const defaults = {
  url: videoUrl,
  youtube: { width: '100%', height: 200, nocookie: false },
  vimeo: { width: '100%', height: 200 },
  vine: { width: '100%', height: 200, embed: 'simple' },
  prezi: { width: '100%', height: 200 },
