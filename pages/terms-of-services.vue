  ...
  <v-app>
    <v-content>
      <v-container>
        ...
        <p>
          By accessing this Website, accessible from https://theopenstories.com,
          https://theopenstories.in and https://theopenstories.xyz, you are
        ...
        <p>
          ...
          materials on The Open Stories's Website for personal, non-commercial
        ...
        <ul>
          ...
          <li>
            attempt to reverse engineer any software contained on The Open
            Stories's Website;
          </li>
          <li>
        ...
        <p>
          This will let The Open Stories to terminate upon violations of any of
        ...
        <p>
          All the materials on The Open Stories’s Website are provided "as is".
          The Open Stories makes no warranties, may it be expressed or implied,
          therefore negates all other warranties. Furthermore, The Open Stories
        ...
        <p>
          The Open Stories or its suppliers will not be hold accountable for any
          damages that will arise with the use or inability to use the materials
          on The Open Stories’s Website, even if The Open Stories or an
        ...
        <p>
          The materials appearing on The Open Stories’s Website may include
          technical, typographical, or photographic errors. The Open Stories
          will not promise that any of the materials in this Website are
          accurate, complete, or current. The Open Stories may change the
          materials contained on its Website at any time without notice. The
          Open Stories does not make any commitment to update the materials.
        </p>

        <h2>6. Links</h2>

        <p>
          The Open Stories has not reviewed all of the sites linked to its
          Website and is not responsible for the contents of any such linked
          site. The presence of any link does not imply endorsement by The Open
          Stories of the site. The use of any linked website is at the user’s
          own risk.
        </p>

        <h2>7. Content on the Services</h2>
        <p>
          ...
          sharing with others. Any use or reliance on any Content or materials
          posted via the Services or obtained by you through the Services is at
        ...
        <p>
          ...
          constitutes copyright infringement, please report this by
          <NLink to="/contact-us">contacting us</NLink>.
        </p>
        ...
        <p>
          ...
          now known or later developed (for clarity, these rights include, for
          example, curating, transforming, and translating). This license
          authorizes us to make your Content available to the rest of the world
          and to let others do the same. You agree that this license includes
          the right for The Open Stories to provide, promote, and improve the
          ...
          conditions for such Content use. Such additional uses by The Open
          Stories, or other companies, organizations or individuals, is made
          ...
          The Open Stories has an evolving set of rules for how ecosystem
          ...
          Content to different media. You represent and warrant that you have,
          or have obtained, all rights, licenses, consents, permissions, power
          and/or authority necessary to grant the rights granted herein for any
          ...
          permission or are otherwise legally entitled to post the material and
          to grant The Open Stories the license described above.
        </p>

        <h2>8. Site Terms of Use Modifications</h2>

        <p>
          The Open Stories may revise these Terms of Use for its Website at any
        ...
        <p>
          Any claim related to The Open Stories's Website shall be governed by
        ...
        <p>
          ...
          above. You can control most communications from the Services. We may
          ...
          able to opt-out from receiving them.
        </p>
        <h2>11. Who May Use the Services</h2>
        <p>
          You may use the Services only if you agree to form a binding contract
          with The Open Stories and are not a person barred from receiving
        ...
        <p>
          The Open Stories gives you a personal, worldwide, royalty-free,
          ...
          by The Open Stories, in the manner permitted by these Terms. The
          ...
          a right to use the The Open Stories name or any of the The Open
          Stories trademarks, logos, domain names, other distinctive brand
          ...
          will remain the exclusive property of The Open Stories and its
          licensors. Any feedback, comments, or suggestions you may provide
          regarding The Open Stories, or the Services is entirely voluntary and
