  ...
  <v-app>
    <v-content>
      <v-container>
        <div>
          <h1>
            The Open Stories' Privacy Notice PRIVACY POLICY Last updated May 03,
            2020
          </h1>

          <p>
            Thank you for choosing to be part of our community at The Open
            Stories (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;,
          ...
          <p>
            When you visit our website https://theopenstories.xyz,
            https://theopenstories.com and https://theopenstories.in, and use
          ...
          <p>
            ...
            website (such as https://theopenstories.xyz,
            https://theopenstories.com and https://theopenstories.in), and/or
            any related services, sales, marketing or events (we refer to them
            collectively in this privacy policy as the &ldquo;Services&ldquo;).
          </p>
          ...
          <p>
            ...
            business entity filings, corporate affiliations, business
            associates; business phone number; phone numbers; current and former
            address; social media; and other similar data.
          </p>
          ...
          <p>
            ...
            called &ldquo;HOW DO WE HANDLE YOUR SOCIAL LOGINS&rdquo; below.
          </p>
          ...
          <p>
            In Short: Some information &mdash; such as IP address and/or browser
          ...
          <p>
            Online Identifiers. We collect devices; tools and protocols, such as
            IP (Internet Protocol) addresses; cookie identifiers, or others such
            as the ones used for analytics and marketing; device&rsquo;s
            geolocation; and other similar data.
          </p>
          ...
          <p>
            ...
            links, including paid listings (such as sponsored links). We will
            inform you about the source of information and the type of
            information and the type of information we have collected about you
          ...
          <p>
            ...
            section below headed &ldquo;HOW DO WE HANDLE YOUR SOCIAL
            LOGINS&rdquo; for further information. To send you marketing and
            ...
            (see the &ldquo;WHAT ARE YOUR PRIVACY RIGHTS&rdquo; below). To send
            ...
            please contact us at privacy@theopenstories.com and be sure to
            ...
            measure its effectiveness. Administer prize draws and competitions.
            We may use your information to administer prize draws and
            competitions when you elect to participate in competitions. Request
            Feedback. We may use your information to request feedback and to
            contact you about your use of our Services. To protect our Services.
            ...
            prevention). To enable user-to-user communications. We may use your
            information in order to enable user-to-user communications with each
            user&rsquo;s consent. To enforce our terms, conditions and policies
            for Business Purposes, Legal Reasons and Contractual. To respond to
            legal requests and prevent harm. If we receive a subpoena or other
            legal request, we may need to inspect the data we hold to determine
            how to respond. To manage user accounts. We may use your information
            for the purposes of managing our account and keeping it in working
            order. To deliver services to the user. We may use your information
            to provide you with the requested service. To respond to user
            ...
            have with the use of our Services. For other Business Purposes. We
            ...
            without your consent. 3. WILL YOUR INFORMATION BE SHARED WITH
            ANYONE?
          </p>
          ...
          <p>
            ...
            securely and retain it for the period we instruct. Business
            ...
            another company. Business Partners. We may share your information
            with our business partners to offer you certain products, services
            or promotions. 4. WHO WILL YOUR INFORMATION BE SHARED WITH?
          </p>

          <p>
            In Short: We only share information with the following third
            parties. We only share and disclose your information with the
            following third parties. We have categorized each party so that you
            may be easily understand the purpose of our data collection and
            ...
            account and Google account Retargeting Platforms Google Ads
            Remarketing User Account Registration and Authentication Facebook
            Login and Google Sign-In Web and Mobile Analytics Google Analytics
            and Heap Analytics 5. DO WE USE COOKIES AND OTHER TRACKING
          ...
          <p>
            ...
            your personal information (see &ldquo;WILL YOUR INFORMATION BE
            SHARED WITH ANYONE?&rdquo; above), in United Kingdom, United States,
          ...
          <p>
            Such measures implementing the European Commission&rsquo;s Standard
            ...
            which require all such recipients to protect personal information
            that they process from the EEA in accordance with European data
            protection laws. Our Standard Contractual Clauses can be provided
            upon request. We have implemented similar appropriate safeguards
            with our third party service providers and partners and further
          ...
          <p>
            ...
            than 90 days past the start of idle period on the user&rsquo;s
            account.
          </p>
          ...
          <p>
            ...
            email us at privacy@theopenstories.com.
          </p>
          ...
          <p>
            ...
            list &ndash; however, we will still need to send you service-related
          ...
          <p>
            ...
            will be notified about data breaches when Termly LLC believes you
            ...
            mental or physical well-being. In the event that Termly LLC becomes
            ...
            Termly LLC will promptly investigate the matter and notify the
          ...
          <p>
            ...
            to review this privacy policy frequently to be informed of how we
          ...
          <p>
            ...
            us, by email at privacy@theopenstories.com.
          </p>
